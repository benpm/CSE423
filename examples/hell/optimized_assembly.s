...
funB:
	...
	push $0 # (int)#3 at -24(%rbp)
	push $0 # (int)#4 at -32(%rbp)
	push $0 # (int)#5 at -40(%rbp)
	push $0 # (int)#6 at -48(%rbp)
	push $0 # (int)#7 at -56(%rbp)
	push $0 # (int)z at -64(%rbp)
	push $0 # (int)g at -72(%rbp)
	push $0 # (int)#2 at -80(%rbp)
.funB.0:
