...
funB:
	...
	pushq $0 # (int)#3 at -24(%rbp)
	pushq $0 # (int)#4 at -32(%rbp)
	pushq $0 # (int)#5 at -40(%rbp)
	pushq $0 # (int)#6 at -48(%rbp)
	pushq $0 # (int)#7 at -56(%rbp)
	pushq $0 # (int)z at -64(%rbp)
	pushq $0 # (int)g at -72(%rbp)
	pushq $0 # (int)#2 at -80(%rbp)
.funB.0:
...
# (51) <[int][SUB], (int)#5, (int)#4, (int)f>
	...
	subq %rcx, %rbx
	movq %rbx, -40(%rbp)
# (51) <[int][CALL], (int)#6, funA, -123, 23, (int)#5>
	pushq -40(%rbp)
	pushq $23
	pushq $-123
	movq -48(%rbp), %rax
